...
public class SpringbootAwsSnsExampleApplication {
    ...
    String TOPIC_ARN = "arn:aws:sns:ap-south-1:890849004240:srikanth-topic";
    ...
    private String buildEmailBody() {
        return "Dear Employee ,\n" +
                "\n" +
                "\n" +
                "Connection down Hyderabad." + "\n" +
                "All the servers in Hyderabad Data center are not accessible. We are working on it ! \n" +
